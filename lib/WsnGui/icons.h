...
const icon_t iconWifi = {24, 18, iconWifiRaw};

// 20 * 18
const  uint8_t  iconClockRaw [] = {
...
const icon_t iconClock = {20, 18, iconClockRaw};

// 12 * 20
const  uint8_t  iconSensorRaw [] = {
...
const icon_t iconSensor = {12, 20, iconSensorRaw};

// 22 * 16
const  uint8_t  iconCloudUpRaw[] = {
...
const icon_t iconCloudUp = {22, 16, iconCloudUpRaw};

// 22 * 14
const  uint8_t  iconCloudDownRaw[] = {
0x00, 0x00, 0x00, 0x02, 0x6b, 0xc8, 0x40, 0x00, 0x00, 0x00, 0x00,  
0x00, 0x00, 0x00, 0x6f, 0xff, 0xff, 0xfc, 0x20, 0x00, 0x00, 0x00,  
0x00, 0x00, 0x07, 0xff, 0x51, 0x01, 0x5e, 0xd2, 0x00, 0x00, 0x00,  
0x00, 0x00, 0x3f, 0xf3, 0x00, 0x00, 0x03, 0xfa, 0x00, 0x00, 0x00,  
...
const icon_t iconCloudDown = {22, 14, iconCloudDownRaw};

// 20 * 20
const  uint8_t  iconRadioRaw [] = {
...
const icon_t iconRadio = {20, 20, iconRadioRaw};
